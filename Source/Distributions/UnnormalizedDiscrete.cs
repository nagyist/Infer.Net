...
namespace MicrosoftResearch.Infer.Distributions
{
	...
	public class UnnormalizedDiscrete : IDistribution<int>, SettableTo<UnnormalizedDiscrete>, Sampleable<int>, IXmlSerializable,
		...
		SettableToWeightedSum<UnnormalizedDiscrete>, CanGetLogAverageOf<UnnormalizedDiscrete>, CanGetAverageLog<UnnormalizedDiscrete>
	{
		...
		/// </summary>
		public int Dimension { get { return logProb.Count; } }
		...
		public void SetToRatio(UnnormalizedDiscrete numerator, UnnormalizedDiscrete denominator)
		{
