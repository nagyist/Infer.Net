...
namespace MicrosoftResearch.Infer.Distributions
{
        ...
        CanGetMeanAndVarianceOut<double,double>
    {
        ...
        double MicrosoftResearch.Infer.Maths.Diffable.MaxDiff(object that)
        {
            throw new NotImplementedException();
        }
		...
		public void SetToRatio(NonconjugateGaussian numerator, NonconjugateGaussian denominator)
        {
