...
namespace MicrosoftResearch.Infer.Distributions
{
 ...
 where T : SettableToUniform,
...
#endif
	{
		...
		{
			SetToFunction(this, delegate(T item) { item.SetToUniform(); return item; });
		}
 ...
 IDistribution<DomainType>
	{
		...
		{
			double sum = 0.0;
			ForEach(value, delegate(T distribution, DomainType item)
			{
...
, SettableTo<DistributionStructArray<T, DomainType>>,
 ...
 where T : struct,
		...
		Sampleable<DomainType>
	{
		...
		/// <param name="numerator">The numerator distribution array</param>
		/// <param name="denominator">The denominator distribution array</param>
		public void SetToRatio(DistributionStructArray<T, DomainType> numerator, DistributionStructArray<T, DomainType> denominator)
		{
			Distribution.SetToRatio(array, numerator.array, denominator.array);
		}
...
, SettableTo<DistributionRefArray<T, DomainType>>,
 ...
 where T : class, ICloneable, SettableTo<T>,
		...
		Sampleable<DomainType>
	{
		...
		/// <param name="numerator">The numerator distribution array</param>
		/// <param name="denominator">The denominator distribution array</param>
		public void SetToRatio(DistributionRefArray<T, DomainType> numerator, DistributionRefArray<T, DomainType> denominator)
		{
			Distribution.SetToRatio(array, numerator.array, denominator.array);
		}
