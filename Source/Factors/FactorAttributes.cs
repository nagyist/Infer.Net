...
namespace MicrosoftResearch.Infer.Factors
{
	...
	public class ParameterNamesAttribute : Attribute
	{
		...
		/// </summary>
		/// <param name="names"></param>
		public ParameterNamesAttribute(params string[] names) { Names = names; }
	}
	...
	/// </summary>
	public class Cancels : Attribute
	{
	}
	...
	/// </summary>
	public class DependsOnIteration 
	{
		/// <summary>
		/// 
		/// </summary>
